...
class IntNumpad():
	...
	def __init__(self, canvas, default_text, font, x, y, width, height, bg, fg, default_val=0, max_val=100):
		self.canvas = canvas
	...
	def create_buttons(self):
		labels = [['7', '8', '9'], ['4', '5', '6'], ['1', '2', '3'], ['0', 'Bck', 'Ent']]
	...
	def click(self, text):
		...
		if text == 'Bck':
			...
			try:
				self.val = int(self.current_text)
				self.has_changed = True				
			except:
				pass
